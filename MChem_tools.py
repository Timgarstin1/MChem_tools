...
# --------------
# 1.06 - date specific (Year,Month,Day) planeflight output reader - tms
# -------------
def readfile(filename, location,  years_to_use, months_to_use, days_to_use, plot_all_data=False,debug=True, **kwargs):
    print 'readfile called'
    big, names = [],[]
...
# --------------
# 1.03 - What GEOS-Chem (GC) Specie am i? takes TRA_## & returns GC ID - setup for tms iodine tracer # > 53 (v9-01-03)
# -------------
def what_species_am_i(input_species) :
    ...
    return tracer_library[input_species]